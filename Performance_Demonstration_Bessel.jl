...
function begintraining()
    ...
    target_func(input) = besselj0.(input[1,:]) .+ besselj0.(input[2,:])
    ...
    savefig(fig2save_pred,"Performance_Demonstration_Figures/Demonstration_Bessel_Predicted.png")
    savefig(fig2save_tar,"Performance_Demonstration_Figures/Demonstration_Bessel_Target.png")
    savefig(fig2save_err,"Performance_Demonstration_Figures/Demonstration_Bessel_Error_Image.png")
    savefig(fig2save_errcurve,"Performance_Demonstration_Figures/Demonstration_Bessel_Error_Curve.png")

    # save latex symbolic output to file
    open("Performance_Demonstration_Symbolic_Results/Demonstration_Bessel_Result.txt", "w") do file
